 ...
 * Plain HAL UART, no external framework dependency
 *
 * Based on: https://github.com/taejin-seong/STM32F103XX-Module-Libraries/tree/master
 * Translated and rewritten to plain STM32 HAL with Claude Code assistance.
 *
 ******************************************************************************
 * @attention
 *
