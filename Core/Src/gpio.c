...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, PN532_RST_Pin|PN532_REQ_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IN1_MOTOR_Pin IN2_MOTOR_Pin IN3_MOTOR_Pin IN4_MOTOR_Pin */
  GPIO_InitStruct.Pin = IN1_MOTOR_Pin|IN2_MOTOR_Pin|IN3_MOTOR_Pin|IN4_MOTOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
