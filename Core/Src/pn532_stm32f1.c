 ...
 *  @author   Yehui from Waveshare (modified for I2C only)
 *  @license  BSD
 *  @source   https://github.com/soonuse/pn532-lib/tree/master
 *  @note     SPI backend removed (I2C-only build); added uid_to_u64() helper
 *            for UID comparison, not present in the original.
 **************************************************************************/
